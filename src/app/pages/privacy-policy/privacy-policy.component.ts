      ...
      <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-sm">
        ...
        <ul class="list-none space-y-2 mb-4">
          ...
          <li>
            ...
            <strong>Velox Immigration Services Inc.</strong>, 125 Castlebar
            Cres, Oshawa ON L1J 7B9. Canada
          </li>
          ...
          <li>
            ...
            <strong>Velox Immigration Services Inc.</strong>, accessible from
            <strong>https://www.veloximmigration.com/</strong>
          </li>
        ...
        <p class="mb-1">Type: Session Cookies</p>
        <p class="mb-1">Administered by: Us</p>
        <p class="mb-4">
        ...
        <p class="mb-1">Type: Persistent Cookies</p>
        <p class="mb-1">Administered by: Us</p>
        <p class="mb-4">
        ...
        <p class="mb-4">
          ...
          signing into Your Account if you have one, and visiting the account
        ...
        <h4 class="text-lg font-bold mb-2">Business Transactions</h4>
        ...
        <h4 class="text-lg font-bold mb-2">Law enforcement</h4>
        ...
        <h4 class="text-lg font-bold mb-2">Other legal requirements</h4>
        ...
        <h2 class="text-2xl font-bold mt-8 mb-4">Links to Other Websites</h2>
        ...
        <p class="mb-4">By email: info&#64;veloximmigration.com</p>

        <p class="mb-4">
          By visiting this page on our website:
          <a
            href="https://www.veloximmigration.com/contact/"
            class="text-blue-600 hover:underline"
            >https://www.veloximmigration.com/contact/</a
          >
        </p>
      </div>
    </div>
